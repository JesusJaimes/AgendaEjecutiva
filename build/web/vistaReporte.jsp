<%-- 
    ...
    Created on : 22-jun-2020, 22:38:45
    Author     : Romario
--%>
...
<%
    ...
    String reporte = (String)request.getSession().getAttribute("reporte");
...
<html>
    <head>
        ...
        <!--my css-->
        <link href="css/vista_reporte_style.css" rel="stylesheet" type="text/css"/>
        <!--my javascirpt-->
