    ...
    <body>
        ...
        <div class="contedio" >
            ...
            <div class="card">
                ...
                <input type='date' name='fecha-fertilizante' placeholder='Fecha de Fertilizante' required/>
                <input type='time' name='tipo-fertilizante' placeholder='Hora' required/>
                ...
                <form id="form-volver-detalles" action="ver_detalles_cultivo.do" method="POST" >
